...
if __name__ == '__main__':
    ...
    parser.add_argument('--init_budget_plan', type=str, choices=['random', 'average', 'RLPlanner', 'PID', 'USCB'], default='PID')
    parser.add_argument('--n_obs_row', type=int, choices=[3], default=3)
    parser.add_argument('--low_agent', type=str, choices=['PID', 'Greedy', 'USCB', 'LP'], default='PID')
    parser.add_argument('--n_epoch', type=int, default=int(100))
    parser.add_argument('--n_task_per_epoch', type=int, default=100)
